...
public class PostRepliesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        repliesRecyclerView.setLayoutManager(new LinearLayoutManager(PostRepliesActivity.this));
        repliesRecyclerView.setHasFixedSize(true);
        repliesAdapter = new RepliesAdapter(PostRepliesActivity.this, replies);
